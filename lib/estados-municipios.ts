// Lista de estados brasileiros e mapeamento para municípios
...
// Usando URLs de bandeiras de um serviço que permite CORS
export const estadosBandeiras: Record<string, string> = {
  ...
  "Espírito Santo": "https://upload.wikimedia.org/wikipedia/commons/4/43/Bandeira_do_Espírito_Santo.svg",
  Goiás: "https://upload.wikimedia.org/wikipedia/commons/b/be/Flag_of_Goiás.svg",
  ...
  "São Paulo": "https://upload.wikimedia.org/wikipedia/commons/2/2b/Bandeira_do_estado_de_São_Paulo.svg",
...
// Base de dados simplificada de municípios brasileiros por estado
export function getMunicipiosPorEstado(estado: string): string[] {
  // Mapeamento simplificado de estado para lista de municípios principais
  ...
  // Retorna a lista de municípios para o estado especificado ou uma lista vazia se o estado não for encontrado
